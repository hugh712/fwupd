...
G_DEFINE_TYPE_WITH_PRIVATE(FuKineticDpFirmware, 
                                                                                    fu_kinetic_dp_firmware, FU_TYPE_FIRMWARE)
...
static const KtDpFwAppIdFlag kt_dp_app_sign_id_table[] = {
    ...
    {KT_CHIP_PUMA_2900,
     0x080042UL,
     {'P', 'U', 'M', 'A'},
     KT_FW_BIN_FLAG_NONE} /* Puma 512KB	*/
};

static gboolean
fu_kinetic_dp_firmware_get_chip_id_from_fw_buf(
                                                                                                            ...
                                                                                                            guint16 *fw_bin_flag)
{
  ...
  for (guint32 i = 0; i < num; i++) {
    ...
    if ((app_id_offset + APP_ID_STR_LEN) < fw_bin_size) {
      if (memcmp(&fw_bin_buf[app_id_offset],kt_dp_app_sign_id_table[i].app_id_str,
                                                                                                                              APP_ID_STR_LEN) == 0) {
...
void
fu_kinetic_dp_firmware_set_isp_drv_size(FuKineticDpFirmware *self, 
                                                                                                                      guint32 isp_drv_size)
{
...
fu_kinetic_dp_firmware_set_esm_payload_size(
                                                                   FuKineticDpFirmware *self, guint32 esm_payload_size)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
guint32
fu_kinetic_dp_firmware_get_esm_payload_size(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
fu_kinetic_dp_firmware_set_arm_app_code_size(
                                                                FuKineticDpFirmware *self, guint32 arm_app_code_size)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
  priv->arm_app_code_size = arm_app_code_size;
  g_debug("firmware set arm code size 0x%x(%u)",priv->arm_app_code_size,priv->arm_app_code_size);  
}

guint32
fu_kinetic_dp_firmware_get_arm_app_code_size(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
fu_kinetic_dp_firmware_set_app_init_data_size(
                                                                      FuKineticDpFirmware *self, guint16 app_init_data_size)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
  priv->app_init_data_size = app_init_data_size;
  g_debug("firmware set app init data size 0x%x(%u)",priv->app_init_data_size,priv->app_init_data_size);
}

guint16
fu_kinetic_dp_firmware_get_app_init_data_size(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
fu_kinetic_dp_firmware_set_cmdb_block_size(
                                                                        FuKineticDpFirmware *self, guint16 cmdb_block_size)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
  priv->cmdb_block_size = cmdb_block_size;
  g_debug("firmware set cmdb block size 0x%x(%u)",priv->cmdb_block_size,priv->cmdb_block_size);  
}

guint16
fu_kinetic_dp_firmware_get_cmdb_block_size(
                                                                                                                          FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
void
fu_kinetic_dp_firmware_set_cmdb_ver(FuKineticDpFirmware *self, 
                                                                                                                guint16 version)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
void
fu_kinetic_dp_firmware_set_cmdb_rev(FuKineticDpFirmware *self,  
                                                                                                                guint32 revision)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
void
fu_kinetic_dp_firmware_set_is_fw_esm_xip_enabled(
                                                    FuKineticDpFirmware *self, gboolean is_fw_esm_xip_enabled)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
gboolean
fu_kinetic_dp_firmware_get_is_fw_esm_xip_enabled(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
...
void
fu_kinetic_dp_firmware_set_std_fw_ver(FuKineticDpFirmware *self, 
                                                                                                                   guint32 std_fw_ver)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
void
fu_kinetic_dp_firmware_set_customer_fw_ver(
                                                                      FuKineticDpFirmware *self, guint32 customer_fw_ver)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
guint32
fu_kinetic_dp_firmware_get_customer_fw_ver(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
void
fu_kinetic_dp_firmware_set_customer_project_id(
                                                                 FuKineticDpFirmware *self, guint32 customer_project_id)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_if_fail(FU_IS_KINETIC_DP_FIRMWARE(self));
...
guint8
fu_kinetic_dp_firmware_get_customer_project_id(
                                                                                                                        FuKineticDpFirmware *self)
{
  FuKineticDpFirmwarePrivate *priv = GET_PRIVATE(self);
  g_return_val_if_fail(FU_KINETIC_DP_FIRMWARE(self), 0);
...
fu_kinetic_dp_firmware_get_valid_payload_size(
                                                                         const guint8 *payload_data, const guint32 data_size)
{
  guint32 i = 0;
                                                                                      ...
                                                                                      GError **error)
{
  ...
  if (!fu_common_read_uint32_safe(buf,bufsz,0,&priv->isp_drv_size,
                                                                                                                        G_LITTLE_ENDIAN,error)) {
    return FALSE;
  }
  g_debug("extracted ISP driver payload size: 0x%x(%u)bytes", 
                                                                                              priv->isp_drv_size,priv->isp_drv_size);

  /* app firmware payload size */
  app_fw_payload_size = g_bytes_get_size(fw_bytes) - 
                                                 HEADER_LEN_ISP_DRV_SIZE - 
                                                 priv->isp_drv_size;
  g_debug("calculated App firmware payload size: 0x%x(%u) bytes", 
                                                                                        app_fw_payload_size, app_fw_payload_size);
  ...
  if (!fu_kinetic_dp_firmware_get_chip_id_from_fw_buf(buf, bufsz, &priv->chip_id
                                                                                                                                   ,&priv->fw_bin_flag)) {
  ...
  if (priv->chip_id == KT_CHIP_JAGUAR_5000 || 
         priv->chip_id == KT_CHIP_MUSTANG_5200) {
    g_debug("parsing Jaguar or Mustang App firmware starts...");
    if (!fu_kinetic_dp_secure_aux_isp_parse_app_fw(firmware, buf,  bufsz, 
                                                                                                                           priv->fw_bin_flag,error)) {
    ...
    if (!fu_kinetic_dp_puma_aux_isp_parse_app_fw(firmware,buf, bufsz,priv->fw_bin_flag, 
                                                                                                                                                                error)) {
